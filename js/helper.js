var makeLengthAngleAxisTransform = function(cyl, cylAxis, center){
...
var createCylinderFromEnds = function (material, radiusTop, radiusBottom, top, bottom, segmentsWidth, openEnded){
      // defaults
      segmentsWidth = 6 ;
      ...
      var cylGeom = new THREE.CylinderGeometry( radiusTop, radiusBottom, length, segmentsWidth, 4, openEnded );
